...
// A parameterized annotation that can be applied to a type parameter.
@Target(ElementType.TYPE_USE)
@interface MaxLen {
  int value();
}

// An annotstion that can be applied to a type parameter.
...
public class TypeAnnoDemo<@What (description = "Generic data type") T> {
  ...
  // Use a type annotation with a throws clauses.
